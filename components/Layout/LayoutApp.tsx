                        ...
                        <nav className="mt-6">
                            ...
                            {router?.query?.tenantId && (
                                <div>
                                    ...
                                    <LinkMenu href={`/app/${router?.query?.tenantId}/campaigns`}>
                                        <span className="text-left">
                                            <svg
                                                width={20}
                                                height={20}
                                    ...
                                    <LinkMenu href={`/app/${router?.query?.tenantId}/public-page`}>
                                        <span className="text-left">
                                            <svg
                                                width={20}
                                                height={20}
                                    ...
                                    <LinkMenu href={`/app/${router?.query?.tenantId}/subscription`}>
                                        <span className="text-left">
                                            <svg
                                                width={20}
                                                height={20}
