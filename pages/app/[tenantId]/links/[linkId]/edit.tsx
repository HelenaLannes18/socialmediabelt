...
const EditLink = () => {
    ...
    const { data } = useGet(
        ...
        router?.query?.linkId &&
        `/api/${router?.query?.tenantId}/links/${router?.query?.linkId}`
    );
    ...
    const submit: SubmitHandler<NewLinkForm> = async (inputs) => {
        const data = await patch({
            url: `/api/${router?.query?.tenantId}/links/${router?.query?.linkId}`,
            data: inputs,
        });
                            ...
                            <div>
                                <div className=" relative ">
                                    <input
                                        ...
                                        {...register('appLink')}
                                    />
                                    {errors?.appLink?.message && <p>{errors?.appLink?.message}</p>}
                                </div>
                            </div>
                        </div>
                    </div>
